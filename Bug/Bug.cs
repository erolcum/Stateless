    ...
    class Bug
    {
        ...
        public Bug(string title)
        {
            ...
            _machine.Configure(State.Assigned)
                ...
                .OnEntryFrom(_assignTrigger, OnAssigned)  // This is where the TriggerWithParameters is used.
                                                          // Note that the TriggerWithParameters object is used, not something from the enum
        ...
        {
            // This is how a trigger with parameter is used, the parameter is supplied
            // to the state machine as a parameter to the Fire method.
